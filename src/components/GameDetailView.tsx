      ...
      <div className="space-y-6 text-left">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-gray-50 rounded-3xl overflow-hidden shadow-inner border border-emerald-50">
              ...
              {game.id !== 'cafe' && game.id !== 'jelly' && game.id !== 'wood' && game.id !== 'snake' && game.id !== 'sudoku' && game.id !== 'minesweeper' && game.id !== 'tictactoe' && game.id !== 'rockpaperscissors' && game.id !== 'tetris' && game.id !== 'breakout' && game.id !== 'bubble' && game.id !== 'tilematching' && game.id !== 'sortworks' && game.id !== 'mahjong' && game.id !== 'fruitmachine' && game.id !== 'checkers' && (
